...
> After Installation Complete you must add your name of Node
<br>
<h2>Add Peers</h2>
...
> Wait status node to `cathing_up = false` for creating wallet
...
```
## Transfer Wallet Balance to Other Wallet
```
...
```
## Withdraw all fund from staking
```
